...
describe('Message and notification', () => {
    ...
    it('MessageAndNotification open check', async () => {
        //MessageAndNotification
        const notificationsMessagesMenuItem = '//android.view.ViewGroup[@resource-id="notificationsMessagesMenuItem"]';
        const NotificationPanetExist = '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]';
        const GoBackButton = ('~Go back');

        await $(notificationsMessagesMenuItem).click();
        await expect($(NotificationPanetExist)).toExist;
