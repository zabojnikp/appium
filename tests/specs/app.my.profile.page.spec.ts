...
describe('My profile page', () => {
    ...
    it('ProfilDetail open check', async () => {
        //ProfilDetail
        const ProfilDetailMenu = '//android.view.ViewGroup[@resource-id="profileDetailMenuItem"]';
        const firstNameProfileDetail = '//android.view.ViewGroup[@resource-id="firstNameProfileDetail"]';
        const MenuBackButton = '//android.widget.Button[@content-desc="Menu, back"]';

        await $(ProfilDetailMenu).click();
        await expect($(firstNameProfileDetail)).toExist;
        await $(MenuBackButton).click();
    });
});