...
describe('Wallet 2.0', () => {
    ...
    it('WalletMenuItem open check', async () => {
        //WalletMenuItem - Opravit jakmile bude venku 4.0!!
        const walletMenuItem = '//android.view.ViewGroup[@resource-id="walletMenuItem"]';
        const GoBackFromMenuButton = ('~Go back');

        await $(walletMenuItem).click();
        await $(GoBackFromMenuButton).click();
    });
});